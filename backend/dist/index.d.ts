...
export { loginHandler, registerHandler, validateTokenHandler, confirmRegistrationHandler } from './handlers/auth.handler';
export { speechToTextHandler, textToSpeechHandler, detectLanguageHandler } from './handlers/voice.handler';
export { getEmergencyCasesHandler, updateEmergencyStatusHandler, getEmergencyContactHandler } from './handlers/emergency.handler';
