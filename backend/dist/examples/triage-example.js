...
exports.basicTriageExample = basicTriageExample;
exports.emergencyEscalationExample = emergencyEscalationExample;
exports.voiceProcessingExample = voiceProcessingExample;
exports.authenticationExample = authenticationExample;
exports.queryHistoryExample = queryHistoryExample;
...
async function basicTriageExample() {
    ...
    try {
        // Perform triage
        const { response, ragContext, processingTimeMs } = await bedrock_service_1.bedrockService.performTriage(triageRequest);
        ...
        // Store in DynamoDB
        await dynamodb_service_1.dynamoDBService.storeTriageResult(triageResult);
...
async function emergencyEscalationExample() {
    ...
    try {
        ...
        if (emergency_service_1.emergencyService.shouldEscalate(triageResult)) {
            console.log('⚠️  EMERGENCY DETECTED - Escalating to PHC');
            const escalation = await emergency_service_1.emergencyService.processEmergency(triageResult);
...
async function voiceProcessingExample() {
    ...
    try {
        ...
        const audioBuffer = await voice_service_1.voiceService.textToSpeech(text, 'hi-IN');
...
async function queryHistoryExample() {
    ...
    try {
        const history = await dynamodb_service_1.dynamoDBService.getUserTriageHistory(userId, 5);
...
//# sourceMappingURL=triage-example.js.map