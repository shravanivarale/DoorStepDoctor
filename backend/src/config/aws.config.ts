...
export function validateConfig(): void {
  const requiredFields = [
    { key: 'bedrock.knowledgeBaseId', value: config.bedrock.knowledgeBaseId },
 ...
 */
export function getEnvironmentConfig(): typeof config {
 ...
 */
export const languageVoiceMap: Record<string, { voiceId: string; languageCode: string }> = {
